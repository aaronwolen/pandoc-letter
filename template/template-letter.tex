...
%append a nice logo and horizontal line
\fancypagestyle{empty}    {\fancyhf{}\fancyhead[L]{\includegraphics[height=0.5in, keepaspectratio=true]{template/logo.eps}}}
\fancypagestyle{firstpage}{\fancyhf{}\fancyhead[L]{\includegraphics[height=0.5in, keepaspectratio=true]{template/logo.eps}}}
\fancypagestyle{plain}    {\fancyhf{}\fancyhead[R]{\includegraphics[height=0.5in, keepaspectratio=true]{template/logo.eps}}}
...
\backgroundsetup{%
  ...
  angle=0,
  opacity=.2,
  contents={\includegraphics[width=\paperwidth]{template/background.eps}},
  hshift=8.8cm,
  vshift=-\paperheight/2-0.8cm
}
$endif$
...
\SetWatermarkColor[HTML]{$watermark-color$}
$endif$
